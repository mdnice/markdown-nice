...
可使用上方工具上传本地图片，目前共支持四种图床：

- SM.MS 图床：直接使用，图床免费，链接长期有效，但是图床不够稳定，会经常存在粘贴失败的现象。
- mdnice 图床：直接使用，图床免费，链接一天内有效，图床稳定性高，基于七牛云搭建。
- 阿里云自定义图床：自行搭建，图床费用参考阿里云收费标准，链接有效期自定义，图床稳定性高，提供[配置文档](https://mp.weixin.qq.com/s/QPsOUkLCsvhqSicTOGaHJg)。
- 七牛云自定义图床：自行搭建，10GB以内空间免费，链接有效期自定义，图床稳定性高，配置文档编写中。
